...
- VRAM: 2 banques (bank 0/1) – tile data/tile maps étendus
- Vitesse: double-speed mode (CPU x2) – impact sur timers/APU/PPU
...
2) Ajouter VRAM banks + palettes CGB (affichage mono palettes → couleur)
