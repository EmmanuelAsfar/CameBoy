...
"C:\TDM-GCC-64\bin\gcc.exe" -Wall -Wextra -std=c99 -O2 -g -Isrc src\cpu.c src\cpu_tables.c src\cpu_tables_cb.c src\mmu.c src\timer.c src\ppu.c src\joypad.c src\graphics_win32.c src\emulator_simple.c -lgdi32 -luser32 -o bin\cameboy_test.exe > compilation_log.txt 2>&1
