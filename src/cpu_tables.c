...
const Instruction opcodes[256] = {
    ...
    [0xD3] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    ...
    [0xDB] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    [0xDC] = {"CALL C, nn", 3, 24, 12, inst_call_c_n16},
    [0xDD] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    ...
    [0xE3] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    [0xE4] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    ...
    [0xEA] = {"LD (nn), A", 3, 16, 0, inst_ld_nn_a},
    [0xEB] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    [0xEC] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    [0xED] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    ...
    [0xF4] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    ...
    [0xFA] = {"LD A, (nn)", 3, 16, 0, inst_ld_a_nn},
    [0xFB] = {"EI", 1, 4, 0, inst_ei},
    [0xFC] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
    [0xFD] = {"ILLEGAL", 1, 0, 0, inst_illegal}, // Illégal
