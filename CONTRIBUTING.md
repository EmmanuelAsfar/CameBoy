...
### Ouverture à contributions

- Corrections PPU/Timer/Joypad pour conformité Blargg/Mooneye.
- Implémentations MBC (MBC1/MBC3) et DMA OAM.
- Améliorations GUI (contrôles, scaling, menus).
